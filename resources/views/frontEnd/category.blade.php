                                        ...
                                        <figure>
                                            <div class="snipcart-item block">
                                                <div class="snipcart-thumb">
                                                    <a href="{{url('/single')}}"><img src="{{asset($categoryProduct->product_image)}}" alt=" " class="img-responsive" /></a>
                                                    <p>{{$categoryProduct->product_name}}</p>
                                                    <h4>${{$categoryProduct->product_price}}.00 <span>$5.00</span></h4>
                                                </div>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset($categoryProduct->product_image)}}" alt=" " class="img-responsive" /></a>
                                                <p>{{$categoryProduct->product_name}}</p>
                                                <h4>{{$categoryProduct->product_price}}<span>$3.00</span></h4>
                                            </div>
                                            <div class="snipcart-details">
                                                <form action="#" method="post">
                                                    <fieldset>
