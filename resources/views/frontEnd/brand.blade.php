            ...
            <div class="w3ls_w3l_banner_nav_right_grid">
                            ...
                            <div class="hover14 column">
                                <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                    <div class="agile_top_brand_left_grid_pos">
                                        <img src="{{asset($brandProduct->product_image)}}" alt=" " class="img-responsive" />
                                    </div>
                                    <div class="agile_top_brand_left_grid1">
                                        <figure>
                                            <div class="snipcart-item block">
                                                <div class="snipcart-thumb">
                                                    <a href="{{url('/single')}}"><img src="{{asset($brandProduct->product_image)}}" alt=" " class="img-responsive" /></a>
                                                    <p>{{$brandProduct->product_name}}</p>
                                                    <h4>${{$brandProduct->product_price}}.00 <span>$5.00</span></h4>
                                                </div>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/6.png" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/7.png" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/8.png" alt=" " class="img-responsive" /></a>
                                ...
                                <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                    ...
                                    <div class="agile_top_brand_left_grid1">
                                        <figure>
                                            <div class="snipcart-item block">
                                                <div class="snipcart-thumb">
                                                    <a href="single.html"><img src="{{asset($brandProduct->product_image)}}" alt=" " class="img-responsive" /></a>
                                                    <p>{{$brandProduct->product_name}}</p>
                                                    <h4>{{$brandProduct->product_price}}<span>$3.00</span></h4>
                                                </div>
                                                <div class="snipcart-details">
                                                    <form action="#" method="post">
                                                        <fieldset>
                ...
                <!--<div class="col-md-3 w3ls_w3l_banner_left">
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/10.png" alt=" " class="img-responsive" /></a>
                    ...
                    <div class="col-md-3 w3ls_w3l_banner_left">
                        <div class="hover14 column">
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                <div class="tag"><img src="{{asset('/front')}}/images/tag.png" alt=" " class="img-responsive" /></div>
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/11.png" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/12.png" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/13.png" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/14.png" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/15.png" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="single.html"><img src="{{asset('/front')}}/images/16.png" alt=" " class="img-responsive" /></a>
