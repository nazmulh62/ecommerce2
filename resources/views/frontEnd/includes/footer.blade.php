    ...
    <div class="container">
        <div class="col-md-3 w3_footer_grid">
            ...
            <ul class="w3_footer_grid_list">
                ...
                <li><a href="{{url('/prouct')}}">Best Deals</a></li>
        ...
        <div class="col-md-3 w3_footer_grid">
            ...
            <ul class="w3_footer_grid_list">
                ...
                <li><a href="{{url('/prouct')}}">Branded Foods</a></li>
        ...
        <div class="wthree_footer_copy">
            <p>© 2017 ESPNBD Store. All rights reserved | Developed by <a href="#">Nazmul Hossain</a></p>
        </div>
    </div>
</div>
